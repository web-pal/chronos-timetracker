...
export const SELECT_ISSUE: string = 'issues/SELECT';
export const SET_TRACKING_ISSUE: string = 'issues/SET_TRACKING';
export const SET_ISSUES_SEARCH_VALUE: string = 'issues/SET_SEARCH_VALUE';
