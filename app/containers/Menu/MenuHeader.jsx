...
class MenuHeader extends Component {
  componentDidMount() {
    ipcRenderer.on('tray-settings-click', this.showSettingsModal);
  }

  componentWillUnmount() {
    ipcRenderer.removeListener('tray-settings-click', this.showSettingsModal);
  }

  showSettingsModal = () => {
    this.props.setShowSettingsModal(true);
  }
